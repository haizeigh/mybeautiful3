                        ...
                        <c:choose>
                            <c:when test="${not empty jobInfos && jobInfos.size()>0}">
                                <c:forEach items="${jobInfos}" var="var" varStatus="vs">
                                    <tr >
                                        <td class='center' style="width: auto; height: 100px">${var.jobGroup}</td>
                                        ...
                                        <td class='center' style="width: auto;">
                                            ...
                                            <a class="btn btn-minier btn-danger" onclick="deleteJob('${var.jobName}','${var.jobGroup}','${var.triggerName}','${var.triggerGroup}');"><i class="icon-edit"></i>删除</a>
                                            <br>
                                        </td>
                                    </tr>
                                </c:forEach>
