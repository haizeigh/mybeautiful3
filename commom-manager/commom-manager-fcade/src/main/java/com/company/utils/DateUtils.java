...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static final String DATE_FORMAT_TIMESTAMP = "yyyy-MM-dd HH:mm:ss.SSS";//年月日,时分秒,毫秒
    ...
    public static SimpleDateFormat getsdfDateTime() {
        return new SimpleDateFormat(DateUtils.DATE_FORMAT_DATETIME);
    }
     ...
     * @return
     */
    public static SimpleDateFormat getLONG_DATE_FORMAT() {
    ...
    /**
     * 将linux时间戳格式 转换为 Date
     */
    public static Date linuxTimeToDate(String linuxTime) {
        if (StringUtils.isBlank(linuxTime))
            return  new Date();
        Long timestamp = Long.parseLong(linuxTime);
    ...
    public static String getReqDateyyyyMMdd(Date date) {
        return getShortDataFormat().format(date);
    }
    ...
    public static Date getStartOfTodayButDelay(int i){

        DateTime dateTime=new DateTime();
        dateTime=dateTime.hourOfDay().withMinimumValue().minuteOfHour().withMinimumValue().secondOfMinute().withMinimumValue().plusMinutes(i);
        return dateTime.toDate();
    }

    public static Date getStartOfMonthButDelay(int i){
        DateTime dateTime=new DateTime();
        dateTime=dateTime.minusDays(1).dayOfMonth().withMinimumValue().hourOfDay().withMinimumValue().minuteOfHour().withMinimumValue().secondOfMinute().withMinimumValue().plusMinutes(i);
       return dateTime.toDate();
    }
    ...
    public static Date getNextMonthFirstDay() {
        DateTime dateTime=new DateTime();
        dateTime=dateTime.dayOfMonth().withMinimumValue().hourOfDay().withMinimumValue().minuteOfHour().withMinimumValue().secondOfMinute().withMinimumValue().plusMonths(1);
       return dateTime.toDate();
    ...
    public static String getSysDateTimeString() {
        return toString(new Date(System.currentTimeMillis()), DateUtils.getsdfDateTime());
    }

    /**
     * 根据指定的Format转化java.sign.Date到String
     *
     * @param dt   java.sign.Date instance
    ...
    /**
     * 利用指定SimpleDateFormat instance转换java.sign.Date到String
     *
     * @param dt        java.sign.Date instance
    ...
    public static String today() {
        return longFormatDate(new Date(), "yyyy-MM-dd");
    }
    ...
    public static String currentTime() {
        return longFormatDate(new Date(), "yyyyMMddhhmmssSSS");
    }
     ...
     * @return String
     */
    public static String longFormatDate(Date date, String format) {
    ...
    public static String getYesterday() {
        ...
        return longFormatDate(calendar.getTime(), "yyyy-MM-dd");
    }
    ...
    public static Date getMinTime(Date dt) {
        Date dt1 = null;
        dt1 = DateUtils.getDateByStr(DateUtils.longFormatDate(dt, "yyyy-MM-dd"));
        return dt1;
    }
    ...
    public static String getBipTime() {
